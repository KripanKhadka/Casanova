// Mock catalog data. Swap `image` URLs for your own product photography,
// or wire this file up to a real API / CMS later.

export const categories = ['Seating', 'Lighting', 'Tables', 'Textiles', 'Objects']
...
export const products = [
  {
    ...
    category: 'Seating',
    price: 1240,
    material: 'Solid oak / wool boucle',
    dimensions: 'W76 × D80 × H72 cm',
    sku: 'FRM-SE-001',
    ...
    description:
      'A low, wide-armed lounge chair built around a steam-bent oak frame. The seat is sprung and finished in a heavyweight boucle that softens with use. Designed to be sat in sideways as often as forwards.',
    stock: 6,
  },
  {
    id: 'brass-arc-pendant',
    name: 'Brass Arc Pendant',
    category: 'Lighting',
    price: 410,
    ...
    description:
      'An asymmetric pendant with a brushed brass arm and an opal glass diffuser that casts a wide, even pool of light. Hangs from a braided cord rated for ceilings up to 4m.',
    stock: 14,
  },
  {
    ...
    description:
      'A single-board walnut top set on a tapered three-leg base, joined without visible hardware. Reads as sculpture as easily as furniture.',
    stock: 9,
  },
  {
    id: 'wool-throw',
    ...
    description:
      'Woven on a traditional Shetland loom from undyed, naturally pigmented fleece. Each throw carries the slight irregularity of the wool it came from.',
    stock: 21,
  },
  {
    ...
    dimensions: '16-piece, service for 4',
    sku: 'FRM-OB-031',
    colors: ['#8A8D91', '#3F3A33'],
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1605883705077-8d3d3cebe78c?q=80&w=1200&auto=format&fit=crop',
    ],
    description:
      'Hand-thrown plates, bowls, and mugs finished in a reactive glaze, so no two pieces break the light in quite the same way.',
    stock: 12,
  },
  {
    id: 'linen-sofa',
    ...
    category: 'Seating',
    price: 2150,
    material: 'Kiln-dried frame / washed linen',
    dimensions: 'W175 × D88 × H78 cm',
    sku: 'FRM-SE-002',
    colors: ['#EDE9E2', '#8A8D91', '#3F3A33'],
    ...
    description:
      "A loose-cushioned two-seater on a kiln-dried hardwood frame, upholstered in pre-washed linen that's built to soften and fade evenly over years of use.",
    stock: 4,
  },
  {
    id: 'rattan-mirror',
    ...
    description:
      'A sunburst frame of hand-split rattan around a beveled mirror plate. Light enough to hang from a single picture hook.',
    stock: 17,
  },
